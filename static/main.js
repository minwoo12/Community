...
/***/ "./assets/js/addBoardComment.js":
/*!**************************************!*\
  !*** ./assets/js/addBoardComment.js ***!
  \**************************************/
/*! exports provided: addBoardComment */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addBoardComment\", function() { return addBoardComment; });\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar addBoardComment = document.getElementById(\"jsAddBoardComment\");\n\nvar sendBoardComment = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(comment) {\n    var boardId, response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            boardId = window.location.href.split(\"/board/\")[1];\n            _context.next = 3;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: \"/api/\".concat(boardId, \"/boardComment\"),\n              method: \"POST\",\n              data: {\n                comment: comment\n              }\n            });\n\n          case 3:\n            response = _context.sent;\n\n            if (response.status === 200) {\n              window.location.reload();\n            }\n\n          case 5:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function sendBoardComment(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar handleBoardComment = function handleBoardComment(event) {\n  event.preventDefault();\n  var commentInput = addBoardComment.querySelector(\"input\");\n  var commentValue = commentInput.value;\n  sendBoardComment(commentValue);\n  commentInput.value = \"\";\n};\n\nfunction init() {\n  addBoardComment.addEventListener(\"submit\", handleBoardComment);\n}\n\nif (addBoardComment) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/addBoardComment.js?");

/***/ }),

/***/ "./assets/js/addBoardReComment.js":
/*!****************************************!*\
  !*** ./assets/js/addBoardReComment.js ***!
  \****************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\nvar addBoardReComment = document.querySelectorAll(\".jsAddBoardReComment\");\n\nvar sendBoardReComment = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(reText, commentId) {\n    var boardId, response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            boardId = window.location.href;\n            _context.next = 3;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()({\n              url: boardId,\n              method: \"GET\",\n              params: {\n                reText: reText,\n                commentId: commentId\n              }\n            });\n\n          case 3:\n            response = _context.sent;\n            console.log(response);\n\n            if (response.status === 200) {\n              window.location.reload();\n            }\n\n          case 6:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function sendBoardReComment(_x, _x2) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\nvar handleBoardReComment = function handleBoardReComment(index) {\n  event.preventDefault();\n  var commentInput = addBoardReComment[index].querySelector(\".jsReComment__text\");\n  var commentIdInput = addBoardReComment[index].querySelector(\".jsCommentId\");\n  var commentInputValue = commentInput.value;\n  var commentIdValue = commentIdInput.value;\n  sendBoardReComment(commentInputValue, commentIdValue);\n  commentInput.value = \"\";\n};\n\nfunction init() {\n  var _loop = function _loop(i) {\n    addBoardReComment[i].addEventListener(\"submit\", index);\n\n    function index() {\n      addBoardReComment[i].index = i;\n      var index = this.index;\n      handleBoardReComment(index);\n    }\n  };\n\n  for (var i = 0; i < addBoardReComment.length; i++) {\n    _loop(i);\n  }\n}\n\nif (addBoardReComment) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/addBoardReComment.js?");

/***/ }),

/***/ "./assets/js/commentBtn.js":
/*!*********************************!*\
  !*** ./assets/js/commentBtn.js ***!
  \*********************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/styles.scss */ \"./assets/scss/styles.scss\");\n/* harmony import */ var _scss_styles_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_styles_scss__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _addBoardComment__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./addBoardComment */ \"./assets/js/addBoardComment.js\");\n/* harmony import */ var _addBoardReComment__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./addBoardReComment */ \"./assets/js/addBoardReComment.js\");\n/* harmony import */ var _commentBtn__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./commentBtn */ \"./assets/js/commentBtn.js\");\n/* harmony import */ var _commentBtn__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_commentBtn__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _paging__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./paging */ \"./assets/js/paging.js\");\n/* harmony import */ var _paging__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_paging__WEBPACK_IMPORTED_MODULE_4__);\n\n\n\n\n\n\n//# sourceURL=webpack:///./assets/js/main.js?");
...
eval("var leftBtn = document.querySelector(\".fa-arrow-alt-circle-left\");\nvar rightBtn = document.querySelector(\".fa-arrow-alt-circle-right\");\nvar parentPage = document.querySelectorAll(\"#jsPageNumber\");\nvar pageCount = document.querySelector(\".countPage\");\nvar pageNumber = parentPage.length;\nvar count = parseInt(pageCount.innerText);\n\nif (parseInt(window.location.href.split(\"main/\")[1]) > pageNumber) {\n  alert(\"존재하지않는 경로입니다.\");\n  window.history.back();\n} else if (parseInt(window.location.href.split(\"main/\")[1]) < 1) {\n  alert(\"존재하지않는 경로입니다.\");\n  window.history.back();\n}\n\nvar page = [];\n\nfor (var i = 0; i < parentPage.length; i++) {\n  page[i] = parentPage[i];\n}\n\nif (pageNumber > 1 && count !== 0) {\n  var startNumber = count - 1;\n  var lastNumber = count + 1;\n\n  if (lastNumber > pageNumber) {\n    lastNumber = count;\n  }\n\n  for (var _i = 0; _i < startNumber; _i++) {\n    page[_i].classList.add(\"hide\");\n  }\n\n  for (var _i2 = startNumber; _i2 < lastNumber; _i2++) {\n    page[_i2].classList.remove(\"hide\");\n  }\n\n  for (var _i3 = lastNumber; _i3 < pageNumber; _i3++) {\n    page[_i3].classList.add(\"hide\");\n  }\n} else {\n  for (var _i4 = 2; _i4 < pageNumber; _i4++) {\n    page[_i4].classList.add(\"hide\");\n  }\n}\n\nvar passRight = function passRight() {\n  count += 2;\n\n  if (count === 8) {\n    window.location.replace(\"http://localhost:4000/board/main/\".concat(pageNumber));\n    alert(\"마지막페이지입니다.\");\n  } else {\n    window.location.replace(\"http://localhost:4000/board/main/\".concat(count));\n  }\n};\n\nvar passLeft = function passLeft() {\n  count -= 2;\n\n  if (count === 0) {\n    window.location.replace(\"http://localhost:4000/board/main/1\");\n  } else {\n    window.location.replace(\"http://localhost:4000/board/main/\".concat(count));\n  }\n};\n\nif (count !== pageNumber - 1) {\n  rightBtn.addEventListener(\"click\", passRight);\n}\n\nif (count !== 1) {\n  leftBtn.addEventListener(\"click\", passLeft);\n}\n\n//# sourceURL=webpack:///./assets/js/paging.js?");
...
eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! D:\\workFile\\portfolio\\Community\\assets\\js\\main.js */\"./assets/js/main.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./assets/js/main.js?");
